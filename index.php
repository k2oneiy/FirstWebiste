			...
			<div class="row">
				<div class="col-lg-8 post-list">
					...
					<section class="post-area">
						...
						$postsel = "SELECT*FROM postcourse WHERE poststatus='published'";
						...
						while($row = mysqli_fetch_assoc($re)){
							...
							$post_content = substr($row['postcontent'],0,20);
					...
					<div class="single-widget category-widget">
						...
						<?php
							...
							while($row = mysqli_fetch_array($result)){
								$value = $row["cattitle"];
								$cateidv = $row['catid'];
								echo "<li><a href='cate_search.php?cate_id=$cateidv' class='justify-content-between align-items-center d-flex myacss ' style='color: black;'>
								{$value}</a></li>";
							}
